                        ...
                        <div style="margin-left: 46%">
                            ...
                            >
                                ...
                                <div class="mb-4">
                                    <button
                                        type="submit"
                                        class="bg-red-500 text-white hover:bg-red-600 py-2 px-4 rounded-md"
                                    >
                                        Save Shipment
                                    </button>
                                </div>
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="mt-4 card-body">
                            ...
                            >
                                ...
                                <div
                                    class="flex-grow-1 ms-3 grid grid-cols-5 gap-x-4 mt-6"
                                >
                                    <!-- Product Name -->
...
const saveShipment = async () => {
    try {
        ...
        formData.append("invoice_no", order.value.invoice.invoice_no);
        formData.append("order_id", order.value.invoice.order_id);
        formData.append(
            "order_address_id",
            order.value.invoice.order_address_id
        );
        formData.append("tracking_no", trackingNo.value);
